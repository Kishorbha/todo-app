...
export default function ProfilePage({ ...props }) {
  return (
    <MasterLayout>
      <Head>
        <title>Todo | {props.user.fullname}</title>
      </Head>
      <div className='max-w-4xl flex items-center h-auto lg:h-full flex-wrap mx-auto m-32 '>
        <div className='w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0'>
          <div className='p-4 md:p-12 text-center lg:text-left'>
            ...
            <p className='pt-4  text-base font-bold flex items-center justify-center lg:justify-start'>
              <MdEmail color='green' className='mx-4' /> {props.user.email}
            </p>
            ...
            <div className='pt-12 pb-8'>
              <button
                className={clsx(
                  ...
                  props.user.isEmailVerified ? 'bg-green-600' : 'bg-red-600',
                )}
              >
                {props.user.isEmailVerified ? 'Verified' : 'Unverified'}
              </button>
            </div>
        ...
        <div className='w-full lg:w-2/5'>
          <img
            ...
            className='rounded-none lg:rounded-lg h-full w-full shadow-2xl hidden lg:block'
          />
        </div>
      </div>
    </MasterLayout>
